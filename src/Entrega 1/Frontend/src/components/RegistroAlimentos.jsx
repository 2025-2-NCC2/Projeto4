  ...
  return (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <fieldset><legend className="text-sm font-medium text-gray-700 dark:text-gray-300">Tipo de Registro</legend><div className="mt-2 flex items-center gap-6"><div className="flex items-center"><input id="entrada" name="tipo" type="radio" value="entrada" checked={tipo === 'entrada'} onChange={() => setTipo('entrada')} className="h-4 w-4 text-green-600" /><label htmlFor="entrada" className="ml-2 block text-sm">Entrada</label></div><div className="flex items-center"><input id="saida" name="tipo" type="radio" value="saida" checked={tipo === 'saida'} onChange={() => setTipo('saida')} className="h-4 w-4 text-red-600" /><label htmlFor="saida" className="ml-2 block text-sm">Saída</label></div></div></fieldset>
