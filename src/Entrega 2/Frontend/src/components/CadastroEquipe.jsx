...
export default function CadastroEquipe() {
  ...
  const handleSubmit = (e) => {
    ...
    // Objeto completo com todos os dados da equipe, incluindo a senha
    const equipeData = {
        nome: nomeEquipe,
    ...
    cadastrarEquipe(equipeData);
    
    // Limpa o formulário após o envio
    setNomeEquipe('');
    setSenha(''); // <-- LIMPANDO O CAMPO DE SENHA
    setMentorNome('');
    setMentorRa('');
    setMentorEmail('');
    setMentorTelefone('');
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
            <label htmlFor="equipe-senha" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Senha Provisória</label>
            <input
              id="equipe-senha" type="password" placeholder="Defina uma senha para a equipe"
