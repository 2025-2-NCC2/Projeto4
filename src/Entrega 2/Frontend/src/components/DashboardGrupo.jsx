...
export default function DashboardGrupo({ nomeEquipe }) {
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200 transition-colors duration-300">
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h1 className="text-xl sm:text-2xl font-bold text-green-700 dark:text-green-400">Painel do Grupo</h1>
        ...
        <main className="space-y-6">
            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-stretch">
                    ...
                    <div className="lg:col-span-1 flex"><MuralAvisos /></div>
                    <div className="lg:col-span-1 flex"><AtividadesRecentes /></div>
                    <div className="lg:col-span-1 flex"><RankingEquipes equipes={equipesOrdenadasValor} /></div>
                    <div className="lg:col-span-1 flex"><RankingAlimentos equipes={equipesOrdenadasItens} /></div>
                </div>
            </div>
